...
export default function Work({ data, id, count, newWork }) {
    ...
    const slider = useRef()
    const workCount = count?.data?.length
    const master_id = data?.masterData?.data?.[0]?.master_id
    const salon_id = data?.salonData?.data?.[0]?.salon_id
    ...
    return (
        ...
        >
            ...
            <div className="works__data">
                ...
                {data.place[0] && data.style[0] && (
                    <div className="works__desc">
                        {data.style[0].name}, {data.place[0].name}
                    </div>
                )}
                <div
                    className="works__author"
                    onClick={(e) => e.stopPropagation()}
                >
                    <SalonLink
                        salonLink={data.masterData.data[0].url}
                        salonCity={data.masterData.data[0].city}
                    ...
                    >
                        ...
                        <div className="author__data">
                            <div className="author__name">
                                {data.masterData.data[0].firstname}{' '}
                                {data.masterData.data[0].lastname}
                            </div>
